                ...
                <div key={sol.id} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                  <div className="flex justify-between items-start gap-3">
                    ...
                    <button
                      ...
                      className={`${sol._esRevisionAsignada
              ...
              {isLoadingDocs ? (
                ...
                <div className="space-y-3">
                  {documentos.map((doc) => {
                    ...
                    return (
                      <div key={doc.id} className={`p-3 rounded-lg border-2 transition-all ${yaAprobado ? 'border-green-500 bg-green-50' :
                          ...
                          {!yaAprobado && !yaRechazado && (
                            <div className="flex gap-1">
                              <button
                                ...
                                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${status === 'rejected'
                              ...
                              <button
                                ...
                                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${status === 'accepted'
